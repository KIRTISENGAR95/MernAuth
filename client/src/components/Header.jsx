...
const Header = () => {
  ...
  return (
    <div className='flex flex-col items-center mt-20 px-4 text-center text-gray-800'>
      ...
      <p className='mb-8 max-w-md'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Sint, minus voluptatum a natus ratione alias nostrum reprehenderit placeat nemo veritatis corporis iusto quas, ipsam autem dolore, possimus iure nesciunt debitis.</p>
